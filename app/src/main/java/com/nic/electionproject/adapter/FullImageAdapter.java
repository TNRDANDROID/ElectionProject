...
import com.nic.electionproject.databinding.GalleryThumbnailBinding;
...
public class FullImageAdapter extends RecyclerView.Adapter<FullImageAdapter.MyViewHolder> {
    ...
    private final com.nic.electionproject.DataBase.dbData dbData;

    private LayoutInflater layoutInflater;

    public FullImageAdapter(Context context, List<ElectionProject> imagePreviewlistvalues, com.nic.electionproject.DataBase.dbData dbData) {
